...
class MobipaidValidationModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        $this->module->addPluginLogger('Mobipaid - process return url', 1, null, 'Cart', $cartId, true);
    ...
    protected function validateOrder($cartId)
    {
        ...
        if (empty($order) || empty($order['order_status'])) {
            $this->module->addPluginLogger('Mobipaid - status url late', 1, null, 'Cart', $cartId, true);
            ...
            $this->module->validateOrder(
                $cartId,
                Configuration::get('MOBIPAID_PAYMENT_STATUS_PENDING'),
                $total,
            ...
            $transactionLog['order_status'] = Configuration::get('MOBIPAID_PAYMENT_STATUS_PENDING');
            ...
            $this->redirectPaymentReturn();
                ...
                $this->module->addPluginLogger(
                    'Mobipaid - redirect success validate return url',
                    1,
                    null,
                    'Cart',
                    $cartId,
    ...
    {
        $url = $this->context->link->getModuleLink('mobipaid', 'paymentReturn', array(

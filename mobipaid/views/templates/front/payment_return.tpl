...
<section id="content-payment-return" class="card definition-list">
    <div class="card-block">
      <div class="row">
        <div class="col-md-12">
            <p>
                {l s='Your order on' mod='mobipaid'} {$shop_name|escape:'htmlall':'UTF-8'} {l s='is in the process.' mod='mobipaid'}
                <br>
                {l s='Please back again after a minutes and check your order history' mod='mobipaid'}
            </p>
        </div>
      </div>
    </div>
